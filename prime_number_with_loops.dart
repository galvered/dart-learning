...
// the next is not reffering to the list but e=rather to the series of integer numbers for(int i=1; i<=10; i++) { print('Hello $i');

// 2 ways of printing even numbers: } for (int i=0; i<=20; i=i+2) { print (i); }

  for (int i = 0; i <= 20; i++) {
    if (i % 2 == 0) {
      print(i);
    }
  } //find odd numbers: for (int i=0; i<=20; i++) { if(i % 2 != 0) { print (i); } }
